...
{
    /// <inheritdoc />
    public partial class SignalRVOne : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParticipantAId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ParticipantBId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
